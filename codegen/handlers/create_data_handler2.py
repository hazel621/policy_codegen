...
@router.post("/hospital_2/create_data/")
async def create_data_handler(agent_id: str, counterparty_role_id:str=None, counterparty_agent_id:str=None, target_role_id: str=None, target_agent_id: str = None, scope: str = None,item: str = None):
    ...
    state_check = check_state(agent_id=agent_id, action_id= "create_data",scope="hospital_2", target_agent_id=target_agent_id, target_role_id=target_role_id, item=item)
    ...
    target_agent_id = "target_agent_id" if "target_agent_id"!="from_request" else target_agent_id
